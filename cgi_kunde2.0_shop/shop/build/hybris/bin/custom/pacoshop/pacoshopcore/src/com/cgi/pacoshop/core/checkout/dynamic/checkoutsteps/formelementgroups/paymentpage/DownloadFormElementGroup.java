...
/**
 * FormElementGroup that implements logic for Download product.
 *
 ...
 *
 */
public class DownloadFormElementGroup extends AbstractPaymentFormElementGroup
{
	...
	{
		return getConfigurationProperty(FormElementGroupConstants.PAYMENT_DOWNLOAD_PRODUCT_TYPE_FORM_ELEMENT_GROUP);
	}
