...
public class DefaultLiveEditBrowserModel extends LiveEditBrowserModel
{
	 ...
	 *
	 * @param cmsUrlChangeEvent Event object.
	 */
	@Override
	...
	/**
	 * Fire toggle preview event.
	 *
	 * @param contentBrowser DefaultLiveEditContentBrowser object.
	 */
	 ...
	 *
	 * @param contentBrowser       DefaultLiveEditContentBrowser object.
	 * @param previewSectionActive Active preview section.
	 */
	...
	/**
	 * New default edit-view model.
	 *
	 * @return DefaultLiveEditViewModel
	 */
	...
	{
		if (this.activeCatalogVersion == null || !this.activeCatalogVersion.equals(actiaveCatalogVersion))
		{
			this.activeCatalogVersion = actiaveCatalogVersion;
