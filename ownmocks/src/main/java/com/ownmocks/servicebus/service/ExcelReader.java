...
import com.ownmocks.servicebus.model.Price;
import com.ownmocks.servicebus.model.SingleProduct;
import com.ownmocks.servicebus.model.SubscriptionProduct;
import java.io.File;
...
public class ExcelReader
{
	...
	public List<SingleProduct> getSingleProduct()
	{
		...
		try
		{
			workbook = Workbook.getWorkbook(new File(String.valueOf(path)), ws);
