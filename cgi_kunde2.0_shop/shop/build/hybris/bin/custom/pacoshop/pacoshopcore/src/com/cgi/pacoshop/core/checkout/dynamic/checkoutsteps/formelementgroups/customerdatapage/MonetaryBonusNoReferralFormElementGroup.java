 ...
 *
 */
public class MonetaryBonusNoReferralFormElementGroup extends AbstractMonetaryBonusFormElementGroup
{
	@Override
	...
	{
		return getConfigurationProperty(FormElementGroupConstants.MONETARY_BONUS_FORM_NO_REFERRAL_ELEMENT_GROUP_NAME);
	}
}
