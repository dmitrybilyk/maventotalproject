 ...
 *  
 */
package com.cgi.pacoshop.core.hmc;
...
/**
 * Provides necessary meta information about the pacoshopcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class PacoshopCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(PacoshopCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.cgi.pacoshop.core.hmc.locales";
