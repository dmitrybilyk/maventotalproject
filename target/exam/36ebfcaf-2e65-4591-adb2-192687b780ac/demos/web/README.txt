...
[uninstalled] [3.0.0 ] wrapper           standard-3.0.0      Provide OS integration
[uninstalled] [3.0.0 ] obr               standard-3.0.0      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [3.0.0 ] config            standard-3.0.0      Provide OSGi ConfigAdmin support
[uninstalled] [3.0.0 ] region            standard-3.0.0      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-3.0.0      Provide Jetty engine support
[uninstalled] [3.0.0 ] http              standard-3.0.0      Implementation of the OSGI HTTP Service
[uninstalled] [3.0.0 ] http-whiteboard   standard-3.0.0      Provide HTTP Whiteboard pattern support
[uninstalled] [3.0.0 ] war               standard-3.0.0      Turn Karaf as a full WebContainer
[uninstalled] [3.0.0 ] deployers         standard-3.0.0      Provide Karaf deployer
[uninstalled] [3.0.0 ] kar               standard-3.0.0      Provide KAR (KARaf archive) support
[uninstalled] [3.0.0 ] webconsole-base   standard-3.0.0      Base support of the Karaf WebConsole
[uninstalled] [3.0.0 ] webconsole        standard-3.0.0      Karaf WebConsole for administration and monitoring
[uninstalled] [3.0.0 ] ssh               standard-3.0.0      Provide a SSHd server on Karaf
...
Maven builds the web application, web-3.0.0.war, and
