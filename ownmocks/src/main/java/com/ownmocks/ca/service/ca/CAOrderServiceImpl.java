 ...
 *
 */
package com.ownmocks.ca.service.ca;

import com.ownmocks.ca.service.ca.api.CAOrderService;
...
public class CAOrderServiceImpl implements CAOrderService
{
     ...
     * (non-Javadoc)
     * 
     * @see com.cgi.pacoshop.mock.ca.api.CAOrderService#createOrder(javax.ws.rs.core.HttpHeaders, byte[])
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.cgi.pacoshop.mock.ca.api.CAOrderService#createOrderError(int)
     */
    @Override
