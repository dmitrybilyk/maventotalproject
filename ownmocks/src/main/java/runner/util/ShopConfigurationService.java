...
public class ShopConfigurationService
{
	...
	// Tells from which tenant is data
	public static final String CONFIG_KEY_MANDANT_ID  = "mandant.id";
	...
	public static final String CONFIG_KEY_SERVICE_BUS_ORIGINS_URL = "servicebus.get.origins.url";

	public static final String CONFIG_KEY_SERVICE_BUS_ORIGINS_TIMEOUT_CONNECT = "servicebus.get.origins.timeout.connect";

	public static final String CONFIG_KEY_SERVICE_BUS_ORIGINS_TIMEOUT_READ = "servicebus.get.origins.timeout.read";

	public static final String CONFIG_KEY_SERVICE_BUS_BUSINESSPARTNER_IDS_URI_TEMPLATE = "servicebus.find.businesspartnerids.uri";

	public static final String CONFIG_KEY_SERVICE_BUS_BUSINESSPARTNER_IDS_TIMEOUT_CONNECT
			  = "servicebus.find.businesspartnerids.timeout.connect";

	public static final String CONFIG_KEY_SERVICE_BUS_BUSINESSPARTNER_IDS_TIMEOUT_READ
			  = "servicebus.find.businesspartnerids.timeout.read";

	public static final String CONFIG_KEY_SERVICE_BUS_BUSINESSPARTNER_IDS_RETRY = "servicebus.find.businesspartnerids.retry";

	private static final Logger LOG                                              =
			  Logger.getLogger(ShopConfigurationService.class);
}
