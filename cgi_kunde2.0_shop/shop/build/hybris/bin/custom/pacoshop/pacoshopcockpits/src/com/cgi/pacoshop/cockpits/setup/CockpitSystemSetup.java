 ...
 *  
 */
package com.cgi.pacoshop.cockpits.setup;
...
import com.cgi.pacoshop.cockpits.constants.PacoshopCockpitsConstants;
 ...
 */
@SystemSetup(extension = PacoshopCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(PacoshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(PacoshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						PacoshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/pacoshopcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
