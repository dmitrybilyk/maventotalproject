...
public interface AddressValidationService
{
	 ...
	 */
	@POST
	@Path("/{offerOrigin}/order/{offerId}/deliverability")
	@Consumes("application/json;charset=UTF-8")
	AddressResponse validateAddress(@PathParam("offerOrigin") String offerOrigin, @PathParam("offerId") String offerId,
