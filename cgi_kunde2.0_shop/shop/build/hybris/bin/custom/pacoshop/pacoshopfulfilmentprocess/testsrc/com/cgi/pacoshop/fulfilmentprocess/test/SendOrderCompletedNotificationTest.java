...
import com.cgi.pacoshop.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction;
...
public class SendOrderCompletedNotificationTest
{
    ...
    @InjectMocks
    private final SendOrderCompletedNotificationAction sendOrderCompletedNotification
            = new SendOrderCompletedNotificationAction();
    ...
    /**
     * Test method for
     * com.cgi.pacoshop.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction#executeAction
     * (OrderProcessModel) .
     */
    @Test
