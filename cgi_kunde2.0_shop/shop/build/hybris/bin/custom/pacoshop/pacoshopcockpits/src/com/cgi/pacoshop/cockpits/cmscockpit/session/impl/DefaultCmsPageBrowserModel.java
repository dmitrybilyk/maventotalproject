 ...
 *  
 */
package com.cgi.pacoshop.cockpits.cmscockpit.session.impl;

import com.cgi.pacoshop.cockpits.cmscockpit.components.contentbrowser.DefaultCmsPageContentBrowser;
import com.cgi.pacoshop.cockpits.cmscockpit.components.contentbrowser.DefaultCmsPageMainAreaPreviewComponentFactory;
...
public class DefaultCmsPageBrowserModel extends CmsPageBrowserModel
{
	...
	{
		final DefaultCmsPageBrowserModel browserModel = (DefaultCmsPageBrowserModel) super.clone();
	...
	/**
	 * New CmsPageMainAreaEditComponentFactory.
	 *
	 * @return New main cms page area.
	 */
	...
	/**
	 * New CmsPageMainAreaPreviewComponentFactory object.
	 *
	 * @return DefaultCmsPageMainAreaPreviewComponentFactory
	 */
	...
	/**
	 * New GridMainAreaComponentFactory object.
	 *
	 * @return CmsPageMainAreaPersonalizeComponentFactory
	 */
				...
				case CHANGED:
					for (final BrowserSectionModel sectionModel : getBrowserSectionModels())
					{
						...
						if ((sectionModel.getRootItem() != null && sectionModel.getRootItem().equals(changedItem)))
						{
							...
							{
                        ((CmsListBrowserSectionModel) sectionModel).setLocked(false);
