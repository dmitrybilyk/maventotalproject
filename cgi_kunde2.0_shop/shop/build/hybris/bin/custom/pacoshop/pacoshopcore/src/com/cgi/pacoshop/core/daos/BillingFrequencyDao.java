...
/**
 * DAO for managing the BillingFrequencyModel objects.
 *
 * @module build
 ...
 *
 */
public interface BillingFrequencyDao
{
	/**
	 * Returns for the given BillingFrequency <code>code</code> the
	 * {@link de.hybris.platform.subscriptionservices.model.BillingFrequencyModel}.
	 *
	 * @param code
