...
import com.cgi.pacoshop.core.service.CDATAAdapter;
...
public class ProductDTO
{
	...
	private String 	  additionalPaymentWithCurrency;
	private String actualBilledPriceWithCurrency;
	private String pricePerUnitWithCurrency;
	...
	/**
	 *
	 * @param priceWithCurrency the priceWithCurrency.
	 */
	public void setPriceWithCurrency(final String priceWithCurrency)
	{
	...
	/**
	 *
	 * @return additionalPaymentWithCurrency
	 */
	public String getAdditionalPaymentWithCurrency()
	{
		return additionalPaymentWithCurrency;
	}
	...
	/**
	 *
	 * @param additionalPaymentWithCurrency the additionalPaymentWithCurrency.
	 */
	public void setAdditionalPaymentWithCurrency(final String additionalPaymentWithCurrency)
	{
		this.additionalPaymentWithCurrency = additionalPaymentWithCurrency;
	}

	/**
	 *
	 * @return actualBilledPriceWithCurrency the actualBilledPriceWithCurrency/
	 */
	public String getActualBilledPriceWithCurrency()
	{
		return actualBilledPriceWithCurrency;
	}

	/**
	 *
	 * @param actualBilledPriceWithCurrency the pricePerUnitWithCurrency.
	 */
	public void setActualBilledPriceWithCurrency(final String actualBilledPriceWithCurrency)
	{
		this.actualBilledPriceWithCurrency = actualBilledPriceWithCurrency;
	}

	/**
	 *
	 * @return pricePerUnitWithCurrency the pricePerUnitWithCurrency.
	 */
	public String getPricePerUnitWithCurrency()
	{
		return pricePerUnitWithCurrency;
	}

	/**
	 *
	 * @param pricePerUnitWithCurrency the pricePerUnitWithCurrency/
	 */
	public void setPricePerUnitWithCurrency(final String pricePerUnitWithCurrency)
	{
		this.pricePerUnitWithCurrency = pricePerUnitWithCurrency;
	}
}
