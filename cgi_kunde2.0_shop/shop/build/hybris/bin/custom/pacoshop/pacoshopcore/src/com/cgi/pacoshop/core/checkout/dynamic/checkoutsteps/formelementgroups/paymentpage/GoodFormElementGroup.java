...
/**
 * Form element group for Good (Guter) product type
 * on payment page
 *
 * @module build
 ...
 *
 */
public class GoodFormElementGroup extends AbstractPaymentFormElementGroup
{

	@Override
	public boolean isNeededProductType(final ProductModel productModel)
	{
		final String download = getConfigurationProperty(FormElementGroupConstants.GOOD);
	...
	{
		return getConfigurationProperty(FormElementGroupConstants.GOOD_FORM_ELEMENT_GROUP);
	}
