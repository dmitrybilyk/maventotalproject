 ...
 *  
 */
package com.cgi.pacoshop.cockpits.cmscockpit.components.contentbrowser;
...
import com.cgi.pacoshop.cockpits.cmscockpit.session.impl.DefaultCmsPageBrowserModel;
...
/**
 * Default implementation of {@link DefaultCmsPageContentBrowser}
 *
	...
	protected AbstractBrowserComponent createCaptionComponent()
	{
		return new CaptionBrowserComponent(this.getModel(), this)
		{
			...
			protected HtmlBasedComponent createCaptionLabelComponent()
			{
				...
				div.appendChild(new Label(DefaultCmsPageContentBrowser.this.getModel().getExtendedLabel()));
				return div;
			}
			...
			protected HtmlBasedComponent createRightCaptionContent()
			{
				...
				if (((DefaultCmsPageBrowserModel) DefaultCmsPageContentBrowser.this.getModel()).isBackButtonVisible())
				{
