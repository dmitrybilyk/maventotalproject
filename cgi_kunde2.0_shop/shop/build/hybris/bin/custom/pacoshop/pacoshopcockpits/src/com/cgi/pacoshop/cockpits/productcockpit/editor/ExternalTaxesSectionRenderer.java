 ...
 *  
 */
package com.cgi.pacoshop.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("pacoshopcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("pacoshopcockpits.product.externalTaxes"));
