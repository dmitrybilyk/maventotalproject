...
public class QueueServiceImpl implements QueueService
{
     ...
     * }
     * 
     * @Override public ActionExecution pollQueue(final BusinessProcessModel process) throws InterruptedException {
     * final BlockingQueue<ActionExecution> queue = nodeExecutions.get(process); final ActionExecution exec =
     * queue.poll(30, TimeUnit.SECONDS); assertNotNull("No node execution in queue. Timeout?", exec);
     * 
