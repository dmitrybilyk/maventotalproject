...
import com.cgi.pacoshop.cockpits.cmscockpit.sitewizard.CMSSiteUtils.RandomProducer;
...
public class CMSSiteUtilsTest
{
	...
	/**
	 * Random producer class.
	 */
	static class RandomProducerImpl implements RandomProducer
	{
		private int idx = 0;
