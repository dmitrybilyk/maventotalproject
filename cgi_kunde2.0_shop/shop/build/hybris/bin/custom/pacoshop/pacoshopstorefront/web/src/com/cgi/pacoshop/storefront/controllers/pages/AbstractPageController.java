...
import com.cgi.pacoshop.storefront.controllers.AbstractController;
...
public abstract class AbstractPageController extends AbstractController
{
	 ...
	 * @throws de.hybris.platform.cms2.exceptions.CMSItemNotFoundException the cms exception
	 * @see
	 */
	@ExceptionHandler(PacoShopWebException.class)
	public String handlePacoshopWebException(final PacoShopWebException exception, final HttpServletRequest request)
