...
/**
 * Form element group for NewsLetter product type
 * on payment page
 *
 * @module build
 ...
 *
 */
public class NewsLetterFormElementGroup extends AbstractPaymentFormElementGroup
{
	...
	{
		return getConfigurationProperty(FormElementGroupConstants.NEWS_LETTER_FORM_ELEMENT_GROUP);
	}
