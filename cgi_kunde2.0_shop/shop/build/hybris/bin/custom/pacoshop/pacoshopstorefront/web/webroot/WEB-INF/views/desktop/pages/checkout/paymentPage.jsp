...
<template:pageRegular pageTitle="${pageTitle}" pageIdentifier="checkout-payment">
    ...
    <c:forEach var="mode" items="${paymentContainer.modes}" varStatus="modeStatus">
        ...
        <fieldset class="payment-api-mode-${mode.type}">
            ...
            <legend>
                <input type="radio" name="paymentMode" id="payment-api-mode-${mode.type}" value="${mode.type}" <c:if test="${mode.type eq paymentContainer.paymentInfo.paymentModeType}">checked="checked"</c:if> />
