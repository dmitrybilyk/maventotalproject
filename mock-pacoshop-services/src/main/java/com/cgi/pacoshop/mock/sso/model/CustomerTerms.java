...
public class CustomerTerms extends AbstractFieldParser
{
	private static final String SSO_MOCK_DATA_TERMS_CELL_PATTERN =
			  "name,termsType,termsVersionId,versionIdentifier,confirmed,refId,version,url,mandatory";
	...
	/**
	 * Indicate if the current term is mandatory.
	 */
	...
	/**
	 * Indicate if current term acceptance is mandatory.
	 *
	 * @return true if current term is mandatory, false otherwise.
	 */
