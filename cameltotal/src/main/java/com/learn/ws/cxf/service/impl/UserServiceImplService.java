...
@WebServiceClient(name = "UserServiceImplService", 
                  wsdlLocation = "http://localhost:8080/total/cxfsoap/UserService?wsdl",
                  targetNamespace = "http://impl.service.cxfsoap.ws.learn.com/")
public class UserServiceImplService extends Service {

    public final static URL WSDL_LOCATION;
    public final static QName SERVICE = new QName("http://impl.service.cxfsoap.ws.learn.com/", "UserServiceImplService");
    public final static QName UserServiceImplPort = new QName("http://impl.service.cxfsoap.ws.learn.com/", "UserServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/total/cxfsoap/UserService?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://localhost:8080/total/cxfsoap/UserService?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
