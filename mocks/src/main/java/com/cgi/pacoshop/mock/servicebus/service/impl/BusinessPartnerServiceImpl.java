...
public class BusinessPartnerServiceImpl implements BusinessPartnerService
{
	...
	private static final Integer POSTALCODE_INDEX          = 9;
	private static final Integer CITY_INDEX                = 10;
	private static final Integer COUNTRY_INDEX             = 11;
	private static final Integer EMAIL_INDEX               = 12;
	private static final Integer EMAIL2_INDEX              = 13;
	private static final Integer PHONE_INDEX               = 14;
	private static final Integer PHONE2_INDEX              = 15;
	private static final Integer MOBIL_INDEX               = 16;
	private static final Integer MOBIL2_INDEX              = 17;
	private static final Integer BIRTHDAY_INDEX            = 18;
		...
		try (FileInputStream inputStream = new FileInputStream(new File(busPartnerFile).getAbsolutePath()))
		{
			...
			while (iterator1.hasNext())
			{
...

				{
					...
					businessPartnerData.setPhone(getRowString(row, PHONE_INDEX));
					businessPartnerData.setPhone2(getRowString(row, PHONE2_INDEX));
					businessPartnerData.setMobil(getRowString(row, MOBIL_INDEX));
					businessPartnerData.setMobil2(getRowString(row, MOBIL2_INDEX));
