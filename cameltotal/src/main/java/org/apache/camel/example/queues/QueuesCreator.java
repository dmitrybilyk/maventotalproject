...
import org.apache.camel.example.queues.model.Student;
 ...
 */
public final class QueuesCreator {

    private QueuesCreator() {
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        context.addComponent("flash-jms", JmsComponent.jmsComponentAutoAcknowledge(connectionFactory));
        // END SNIPPET: e2
        // Add some configuration by hand ...
        // START SNIPPET: e3
//        context.addRoutes(new RouteBuilder() {
//            public void configure() {
//                from("flash-jms:queue:test.queue").to("file://testOfFlashJms");
//            }
//        });
        // END SNIPPET: e3
        ...
        // START SNIPPET: e5
        for (int i = 0; i < 3; i++) {
            template.sendBody("flash-jms:queue:flash.test.queue", new Student("diminchik" + i, 33 + i));
        }
        // END SNIPPET: e5
