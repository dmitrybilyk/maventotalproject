...
public class ConsignmentCollectionReminderEmailContext extends AbstractEmailContext<ConsignmentProcessModel>
{
	...
	/**
	 * @param pConsignmentConverter Converter
	 */
	@Required
	public void setConsignmentConverter(final Converter<ConsignmentModel, ConsignmentData> pConsignmentConverter)
	{
		this.consignmentConverter = pConsignmentConverter;
	}
	...
	/**
	 *
	 * @param pCustomerServiceUncollectedConsignmentStrategy CustomerServiceUncollectedConsignmentStrategy
	 */
	@Required
	public void setCustomerServiceUncollectedConsignmentStrategy(
			final CustomerServiceUncollectedConsignmentStrategy pCustomerServiceUncollectedConsignmentStrategy)
	{
		this.customerServiceUncollectedConsignmentStrategy = pCustomerServiceUncollectedConsignmentStrategy;
	}
	...
	/**
	 *
	 * @param pFormatFactory formatFactory
	 */
	@Required
	public void setFormatFactory(final FormatFactory pFormatFactory)
	{
		this.formatFactory = pFormatFactory;
	}
}
