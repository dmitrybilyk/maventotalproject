...
/**
 * This is event for starting process error email sending
 *
 * @module build
 ...
 *
 */
public class OrderErrorEvent extends OrderProcessingEvent
{
	 ...
	 * @throws Exception
	 */
	public OrderErrorEvent(final OrderProcessModel process)
	{
		super(process);
	}
}
